  ...
  module Models
    module TwoFactorAuthenticatable
      ...
      def self.required_fields(_klass)
        %i[encrypted_otp_secret encrypted_otp_secret_iv encrypted_otp_secret_salt consumed_timestep]
      end
      ...
      def validate_and_consume_otp!(code, options = {})
        ...
        totp = otp(otp_secret)
        if totp.verify(code, drift_ahead: self.class.otp_allowed_drift)
          return consume_otp!
        end
